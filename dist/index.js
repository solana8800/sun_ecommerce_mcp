...
import { CallToolRequestSchema, ListToolsRequestSchema, ListResourcesRequestSchema, ReadResourceRequestSchema, GetPromptRequestSchema, ListPromptsRequestSchema, } from '@modelcontextprotocol/sdk/types.js';
...
class SunEcommerceMCPServer {
    ...
    setupHandlers() {
        ...
        this.server.setRequestHandler(GetPromptRequestSchema, async (request) => {
            try {
                const result = await this.handlePromptRequest(request.params.name, request.params.arguments || {});
                return result;
            }
            catch (error) {
