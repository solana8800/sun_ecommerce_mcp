import { CreateProductSchema, SearchProductsParamsSchema, GetProductParamsSchema, CreateCategorySchema, CreatePricingRuleSchema, ApplyPricingRuleParamsSchema, CreateCartParamsSchema, AddCartItemSchema, UploadMediaSchema, } from '../types/index.js';
export class ToolHandler {
    ...
    async listPricingRules(args) {
        ...
        return {
            ...
            summary: {
                ...
                activeRules: result.data?.filter((rule) => rule.isActive).length || 0,
            },
        };
    }
    ...
    async listMedia(args) {
        ...
        if (args.entityType)
            params.entity_type = args.entityType;
        if (args.entityId)
            params.entity_id = args.entityId;
        if (args.mediaType)
            params.media_type = args.mediaType;
    ...
    async getPricingRuleByName(args) {
    ...
    async updatePricingRuleStatus(args) {
    ...
    async getActivePricingRules(args) {
    ...
    async getPricingRulesByPriority(args) {
    ...
    async bulkUpdatePricingRuleStatus(args) {
    ...
    async getPricingRuleStats(args) {
    ...
    async duplicatePricingRule(args) {
    ...
    async bulkCreateAttributeValues(args) {
