    ...
    inputSchema: {
      ...
      properties: {
        tree: {
          type: "boolean",
          default: false,
          description: "Trả về cấu trúc cây phân cấp",
        },
    ...
    inputSchema: {
      ...
      properties: {
        ...
        conditions: {
          type: "object",
          description:
            "Điều kiện quy tắc (số lượng tối thiểu, ID danh mục, v.v.)",
        },
        actions: {
          type: "object",
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        customAttributes: {
          type: "object",
          description: "Thuộc tính tùy chỉnh của sản phẩm",
        },
      },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        itemId: {
          type: "string",
          description: "UUID sản phẩm trong giỏ hàng cần xóa",
        },
      },
    ...
    inputSchema: {
      ...
      properties: {
        ...
        expiresAt: {
          type: "string",
          format: "date-time",
          description: "Thời gian hết hạn đặt trước",
        },
      },
      required: ["items"],
    },
    ...
    inputSchema: {
      ...
      properties: {
        ...
        tags: {
          type: "array",
          items: { type: "string" },
          description: "Thẻ tag cho tệp media",
        },
      },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        valueId: {
          type: "string",
          description: "UUID giá trị thuộc tính cần xóa",
        },
      },
      required: ["attributeId", "valueId"],
    },
  ...
  // Inventory Management Tools
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        allocation_type: {
          type: "string",
          description: "Lọc theo loại phân bổ",
        },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        allocation_type: {
          type: "string",
          enum: ["GENERAL", "CHANNEL", "PARTNER"],
          description: "Loại phân bổ",
        },
        channel_id: {
          type: "string",
          description: "UUID kênh bán (nếu allocation_type = CHANNEL)",
        },
        partner_id: {
          type: "string",
          description: "UUID đối tác (nếu allocation_type = PARTNER)",
        },
      },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        quantity: {
          type: "number",
          description: "Số lượng biến động (dương cho IN, âm cho OUT)",
        },
        reason: { type: "string", description: "Lý do biến động" },
        reference_id: {
          type: "string",
          description: "ID tham chiếu (đơn hàng, phiếu nhập, v.v.)",
        },
    ...
    inputSchema: {
      ...
      properties: {
        ...
        quantity: {
          type: "number",
          minimum: 1,
          description: "Số lượng cần đặt trước",
        },
        channel_id: { type: "string", description: "UUID kênh bán" },
        partner_id: { type: "string", description: "UUID đối tác" },
        ...
        reference_id: {
          type: "string",
          description: "ID tham chiếu (đơn hàng, giỏ hàng)",
        },
      },
      required: ["variant_id", "quantity"],
    },
    ...
    inputSchema: {
      ...
      properties: {
        ...
        quantity: {
          type: "number",
          minimum: 1,
          description: "Số lượng cần hủy đặt trước",
        },
        channel_id: { type: "string", description: "UUID kênh bán" },
        partner_id: { type: "string", description: "UUID đối tác" },
        reference_id: {
  ...
  // Partner Management Tools
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        search: {
          type: "string",
          description: "Tìm kiếm theo tên hoặc mã đối tác",
        },
      },
    },
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        type: {
          type: "string",
          description: "Loại đối tác (DISTRIBUTOR, RETAILER, SUPPLIER)",
        },
        tier: {
          type: "string",
          description: "Cấp độ đối tác (BRONZE, SILVER, GOLD, PLATINUM)",
        },
  ...
  // Sales Channel Management Tools
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        search: {
          type: "string",
          description: "Tìm kiếm theo tên hoặc mã kênh",
        },
      },
    },
  },
    ...
    inputSchema: {
      ...
      properties: {
        ...
        type: {
          type: "string",
          description:
            "Loại kênh bán (ONLINE, OFFLINE, MARKETPLACE, MOBILE_APP)",
        },
    ...
    inputSchema: {
      ...
      properties: {
        ...
        metrics: {
          type: "array",
          items: { type: "string" },
          description: "Các chỉ số cần thống kê",
        },
      },
      required: ["id"],
    },
