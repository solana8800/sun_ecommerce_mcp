export const promptDefinitions = [
  {
    ...
    description:
      "Trình hướng dẫn tương tác để hướng dẫn người dùng tạo sản phẩm",
    arguments: [
      {
        name: "productType",
        description:
          "Loại sản phẩm cần tạo (đơn giản, có thể cấu hình, gói, v.v.)",
        required: false,
      },
      {
        name: "category",
  ...
  },
  {
    ...
    description:
      "Hướng dẫn người dùng thiết lập quy tắc định giá và khuyến mãi",
    arguments: [
      {
        name: "ruleType",
        description:
          "Loại quy tắc định giá (giảm giá theo phần trăm, giảm giá cố định, v.v.)",
        required: false,
      },
      {
        name: "targetProducts",
  ...
  },
  {
    ...
    description:
      "Giúp người dùng chẩn đoán và giải quyết các vấn đề tích hợp API",
    arguments: [
      {
        name: "issue",
  ...
  },
  {
    ...
    description:
      "Hoạt động như một chuyên gia tư vấn chiến lược thương mại điện tử cung cấp lời khuyên kinh doanh",
    arguments: [
      {
        name: "topic",
        description:
          "Lĩnh vực tập trung (chiến lược sản phẩm, định giá, tồn kho, trải nghiệm khách hàng, v.v.)",
        required: false,
      },
      {
        name: "businessType",
  ...
  },
  {
    ...
    description:
      "Cung cấp khuyến nghị để tối ưu hóa cấu trúc danh mục sản phẩm",
    arguments: [
      {
        name: "catalogSize",
  ...
  },
  {
    ...
    description:
      "Cung cấp lời khuyên chiến lược về mô hình định giá và vị thế cạnh tranh",
    arguments: [
      {
        name: "pricingModel",
        description:
          "Mô hình định giá hiện tại (cố định, động, theo cấp, v.v.)",
        required: false,
      },
      {
        name: "competitivePosition",
        description:
          "Vị thế so với đối thủ cạnh tranh (cao cấp, giá trị, ngân sách)",
        required: false,
      },
      {
        name: "margins",
  ...
  },
  {
    ...
    description:
      "Giúp tối ưu hóa quản lý tồn kho và giảm thiểu tình trạng hết hàng/tồn kho dư thừa",
    arguments: [
      {
  ...
  },
  {
    ...
    description:
      "Kiểm toán hiệu suất nền tảng hiện tại và cung cấp khuyến nghị tối ưu hóa",
    arguments: [
      {
        name: "responseTime",
  ...
  },
  {
    ...
    description:
      "Lập kế hoạch di chuyển từ nền tảng thương mại điện tử hiện có",
    arguments: [
      {
      ...
      },
      {
        name: "downtime",
        description:
          "Thời gian ngừng hoạt động có thể chấp nhận cho việc di chuyển",
        required: false,
      },
    ],
  },
  {
    ...
    description:
      "Phát triển chiến lược kiểm thử toàn diện cho triển khai thương mại điện tử",
    arguments: [
      {
        name: "testingTypes",
        description:
          "Các loại kiểm thử cần thiết (đơn vị, tích hợp, hiệu suất, v.v.)",
        required: false,
      },
      {
